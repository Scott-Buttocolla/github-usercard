...
const followersArray = ['bigknell', 'belzy', 'tetondan', 'scott-buttocolla', 'dswhitely1'];
...
axios.get('https://api.github.com/users/scott-buttocolla/following')
.then(response => {console.log(response.data); 
...
.catch(error => {console.log('Error! : ' + error)})
  ...
  // const names = userData.data.message
  // names.forEach(name =>{
  //   const card = followerCard({realName: name})
  //   cardsPoint.appendChild(card)
  // })


// console.log(followerCard(followersArray))
// const followers = followersArray.map((followersArray)=>{
//   return followerCard(followersArray);
// })
// followers.forEach((followers)=>{
//   cardsPoint.appendChild(followers)
// })
